...
if (isset($_POST['submit'])) {
    ...
    $sqlins = "INSERT INTO `departamentocatalogo`
    (`id`, `departamento`, `descripcion`) VALUES (NULL, $departamento,'$descripcion')";
    $result = mysqli_query($conn, $sqlins);

    if ($result) {
        header("location: departamentoCatalogos.php?msg=Departamento registrada con éxito.");
    }
}
?>
...
<body>
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM departamentocatalogo";
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td><a href="editarDepartamento.php?id=' . $row["id"] .'" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a></td>
                        <td><a href="eliminarDepartamento.php?id=' . $row["id"] . '" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a></td>  
                    </tr>
                    ';
                }
                ?>
    ...
    <div class="container" style="margin-bottom: 35px;">
        <div class="text-center mb-4 fs-4">Agregar Nuevo Departamento</div>
