...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        header("location: partidasCatalogos.php?msg=Partida actualizado con éxito.");
    }
}
?>
...
<body>
    ...
    <div class="container" style="margin-bottom: 35px;">
        <div class="text-center mb-4 fs-4">Editar Partida</div>
        <?php
        $id = $_GET['id'];
        $sql = "SELECT * FROM `partidacatalogo` WHERE id = '$id' LIMIT 1";
        ...
        <div class="container d-flex justify-content-center">
            ...
            <div class="col">
                    ...
                    <input type="text" class="form-control" name="partida" value="<?php echo $row['partida'];?>">
                </div> 
            <div class="col">
